package com.luke.cloud.account.service.impl;

import com.baomidou.mybatisplus.core.conditions.query.QueryWrapper;
import com.luke.cloud.account.bean.Account;
import com.luke.cloud.account.bean.AccountFreeze;
import com.luke.cloud.account.dao.AccountFreezeMapper;
import com.luke.cloud.account.dao.AccountMapper;
...
public class AccountServiceImpl implements AccountService {
    ...
    @MiloTCC(confirmMethod = "decreaseAccountConfirm", cancelMethod = "decreaseAccountCancel")
    @Override
    public Integer decrease(DecreaseAccountReq req) {
        ...
        if(dbAccount != null){
            ...
            //模拟try阶段处理出现异常
            //throw new MiloException("扣款出现异常");
        }
